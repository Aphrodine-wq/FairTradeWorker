...
const App: React.FC = () => {
  ...
  const roleNavConfig = useMemo((): NavItemConfig[] => {
    ...
    if (profile.role === UserRole.HOMEOWNER) {
      ...
      specificNav = [
        ...
        { id: 'CREW_MGMT', label: 'Crew Management', visible: true },
        { id: 'CRM', label: 'Pipeline', visible: true },
        { id: 'ESTIMATES', label: 'Estimates', visible: true },
        { id: 'AI_RECEPTIONIST', label: 'Phone Assistant', visible: true },
      ...
      specificNav = [
        ...
        { id: 'CREW_MGMT', label: 'My Crew', visible: true },
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'AI_RECEPTIONIST': return <AIReceptionist />;
      ...
      case 'CREW_MGMT': return <CrewManagement role={profile.role} />;
      default: return null;
    }
  };
