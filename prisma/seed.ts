...
async function main() {
  ...
  const job1 = await prisma.job.create({
    data: {
      ...
      budgetMax: 55000,
      location: "Austin, TX",
      fullAddress: "4821 Balcones Dr, Austin, TX 78731",
      status: "OPEN",
      urgency: "MEDIUM",
      propertyType: "RESIDENTIAL",
      sqft: 2400,
  ...
  const job2 = await prisma.job.create({
    data: {
      ...
      budgetMax: 6000,
      location: "Dallas, TX",
      fullAddress: "1127 Mockingbird Ln, Dallas, TX 75205",
      status: "OPEN",
      urgency: "HIGH",
      propertyType: "RESIDENTIAL",
      sqft: 1800,
  ...
  const job3 = await prisma.job.create({
    data: {
      ...
      budgetMax: 28000,
      location: "San Antonio, TX",
      fullAddress: "903 King William St, San Antonio, TX 78204",
      status: "IN_PROGRESS",
      urgency: "LOW",
      propertyType: "RESIDENTIAL",
      sqft: 3200,
  ...
  await prisma.notification.createMany({
    data: [
      ...
      },
      {
        ...
        body: "Kitchen Remodel — Full Gut and Rebuild in Austin, TX. Budget: $35K-$55K.",
        data: { jobId: job1.id },
      },
      {
      ...
      },
      {
        ...
        body: "Drywall & tape work needed for a kitchen remodel in Austin, TX. Budget: $2,800-$4,200.",
