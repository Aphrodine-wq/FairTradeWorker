...
const BASE = "/demo/subcontractor";

const NAV_ITEMS = [
  { label: "Dashboard", href: `${BASE}/dashboard`, icon: LayoutDashboard },
  { label: "Browse Sub Jobs", href: `${BASE}/work`, icon: Briefcase },
  { label: "Estimates", href: `${BASE}/estimates`, icon: FileText },
  { label: "Projects", href: `${BASE}/jobs`, icon: FolderOpen },
...
export default function DemoSubcontractorLayout({ children }: { children: React.ReactNode }) {
