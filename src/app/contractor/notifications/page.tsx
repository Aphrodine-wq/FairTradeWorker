...
const NOTIFICATIONS: Notification[] = [
  {
    ...
    title: "Michael Brown viewed your estimate",
    body: "Kitchen Remodel - Full Gut — $38,500",
    time: "2 min ago",
    read: false,
    href: "/contractor/estimates?tab=my-estimates",
  },
  {
    id: "n2",
    type: "message",
    title: "New message from Sarah Williams",
    body: "Hey Marcus, quick question about the tile selection for the shower...",
    time: "18 min ago",
    read: false,
  ...
  },
  {
    ...
    body: "Fence Installation — 150 LF Cedar, Starkville, MS — $5,000–$8,000",
    time: "45 min ago",
    read: false,
  ...
  },
  {
    id: "n4",
    type: "inspection",
    title: "Inspection scheduled tomorrow",
    body: "Roof Inspection — 15230 Cypress Creek, Houston — 1:00p",
    time: "1 hr ago",
    read: false,
  ...
  },
  {
    ...
    title: "Payment received — $7,600",
    body: "Sarah Williams paid INV-2026-003 for Bathroom Renovation",
    time: "3 hrs ago",
    read: true,
  ...
  },
  {
    ...
    body: "Sarah Williams accepted your estimate for Bathroom Renovation — $15,200",
    time: "5 hrs ago",
    read: true,
    href: "/contractor/estimates?tab=my-estimates",
  },
  {
    ...
    title: "Invoice overdue — 6 days",
    body: "INV-2026-004 for Robert Johnson (Deck Build) — $11,000",
    time: "6 hrs ago",
    read: true,
    href: "/contractor/invoices",
  },
  {
    ...
    body: "Michael Brown left a review: \"Exceptional work on our kitchen remodel...\"",
    time: "Yesterday",
    read: true,
  ...
  },
  {
    ...
    body: "Kitchen Remodel — Cabinet Install marked complete",
    time: "Yesterday",
    read: true,
    href: "/contractor/projects",
  },
  {
    ...
    body: "Chris Martinez declined your estimate for Fence Installation — $6,750",
    time: "2 days ago",
    read: true,
    href: "/contractor/estimates?tab=my-estimates",
  },
  {
    ...
    type: "new_job",
    title: "New job posted near you",
    body: "HVAC System Replacement — Oxford, MS — $6,000–$10,000",
    time: "2 days ago",
    read: true,
    href: "/contractor/work",
  },
  {
    ...
    body: "When do you think the deck boards will be in? My wife is asking...",
    time: "3 days ago",
    read: true,
    href: "/contractor/messages",
  },
