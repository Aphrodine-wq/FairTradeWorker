        ...
        <Card className="shadow-md">
          <CardContent className="p-8">
            {step === 1 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-sm text-gray-700">Tell homeowners about your company.</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-gray-900">Years experience</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-gray-900">About your business</label>
                  <textarea
                    rows={3}
            ...
            {step === 2 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-sm text-gray-700">Where you work and what you do best.</p>
                </div>
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-gray-900">Service radius (miles)</label>
                  <Input type="number" min="5" max="200" value={serviceRadius} onChange={(e) => setServiceRadius(e.target.value)} />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-900">Skills (select all that apply)</label>
            ...
            {step === 3 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-sm text-gray-700">Optional but increases your trust score and bid acceptance rate.</p>
                </div>

                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-gray-900">License number</label>
            ...
            {step === 4 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-sm text-gray-700">Homeowners trust insured contractors. Upload your certificate of insurance.</p>
                </div>

                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-gray-900">Insurance provider</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-gray-900">Coverage type</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-gray-900">Coverage amount ($)</label>
            ...
            <div className="flex gap-3 mt-8">
              ...
              {step >= 3 && step < 4 && (
                <Button variant="ghost" onClick={() => setStep((s) => (s + 1) as Step)} className="text-gray-600 text-sm">
                  Skip
                </Button>
              )}
              {step === 4 && (
                <Button variant="ghost" onClick={handleComplete} disabled={saving} className="text-gray-600 text-sm">
                  Skip
                </Button>
              )}
            </div>
