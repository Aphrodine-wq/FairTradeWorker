...
export async function POST(req: NextRequest) {
  ...
  const homeowner1User = await prisma.user.create({
    data: {
      ...
      homeowner: { create: { location: "Austin, TX", propertyType: "RESIDENTIAL" } },
    },
  });
  const homeowner2User = await prisma.user.create({
    data: {
      ...
      roles: ["HOMEOWNER"], activeRole: "HOMEOWNER", emailVerified: true,
      homeowner: { create: { location: "Dallas, TX", propertyType: "RESIDENTIAL" } },
    },
  });
  const homeowner3User = await prisma.user.create({
    data: {
      ...
      roles: ["HOMEOWNER"], activeRole: "HOMEOWNER", emailVerified: true,
      homeowner: { create: { location: "San Antonio, TX", propertyType: "RESIDENTIAL" } },
    },
  });
  ...
  const contractor1User = await prisma.user.create({
    data: {
      ...
      contractor: { create: { company: "Johnson & Sons Construction", bio: "Third-generation contractor specializing in residential remodels and new construction.", specialty: "General Contracting", skills: ["Framing", "Finish Carpentry", "Project Management", "Concrete"], location: "Austin, TX", serviceRadius: 50, yearsExperience: 15, hourlyRate: 85, verified: true, licensed: true, insured: true, fairTradePromise: true, rating: 4.9, reviewCount: 127, jobsCompleted: 342 } },
    },
  });
  const contractor2User = await prisma.user.create({
    data: {
      ...
      roles: ["CONTRACTOR"], activeRole: "CONTRACTOR", emailVerified: true,
      contractor: { create: { company: "Precision Electric LLC", bio: "Master electrician with expertise in residential and light commercial work.", specialty: "Electrical", skills: ["Panel Upgrades", "EV Chargers", "Smart Home", "Troubleshooting"], location: "Dallas, TX", serviceRadius: 40, yearsExperience: 12, hourlyRate: 95, verified: true, licensed: true, insured: true, fairTradePromise: true, rating: 4.8, reviewCount: 89, jobsCompleted: 256 } },
    },
  });
  const contractor3User = await prisma.user.create({
    data: {
      ...
      roles: ["CONTRACTOR"], activeRole: "CONTRACTOR", emailVerified: true,
      contractor: { create: { company: "Garcia Plumbing Services", bio: "Licensed master plumber serving San Antonio for over 20 years.", specialty: "Plumbing", skills: ["Pipe Repair", "Bathroom Remodels", "Water Heaters", "Sewer Lines"], location: "San Antonio, TX", serviceRadius: 60, yearsExperience: 20, hourlyRate: 90, verified: true, licensed: true, insured: true, fairTradePromise: true, rating: 4.7, reviewCount: 203, jobsCompleted: 512 } },
    },
  });
  const contractor4User = await prisma.user.create({
    data: {
      ...
      contractor: { create: { company: "Mitchell Roofing Co.", bio: "Full-service roofing contractor specializing in storm damage repair and metal roofing.", specialty: "Roofing", skills: ["Metal Roofing", "Shingle Replacement", "Storm Damage", "Inspections"], location: "Houston, TX", serviceRadius: 75, yearsExperience: 18, hourlyRate: 75, verified: true, licensed: true, insured: true, fairTradePromise: true, rating: 4.9, reviewCount: 156, jobsCompleted: 428 } },
      subContractor: { create: { company: "Mitchell Roofing Co.", bio: "Available for roofing sub-work on larger projects.", specialty: "Roofing", skills: ["Metal Roofing", "Shingle Replacement", "Storm Damage"], location: "Houston, TX", serviceRadius: 75, yearsExperience: 18, hourlyRate: 65, verified: true, licensed: true, insured: true, rating: 4.9, reviewCount: 42, subJobsCompleted: 87 } },
    },
  });
  ...
  const sub1User = await prisma.user.create({
    data: {
      ...
      subContractor: { create: { company: "Alvarez Drywall & Tape", bio: "Drywall hanging and finishing for residential and commercial.", specialty: "Drywall", skills: ["Hanging", "Taping", "Texturing", "Patching"], location: "Austin, TX", serviceRadius: 30, yearsExperience: 10, hourlyRate: 55, verified: true, licensed: true, insured: true, rating: 4.7, reviewCount: 38, subJobsCompleted: 145 } },
    },
  });
  const sub2User = await prisma.user.create({
    data: {
      ...
      roles: ["SUBCONTRACTOR"], activeRole: "SUBCONTRACTOR", emailVerified: true,
      subContractor: { create: { company: "Wells Tile & Stone", bio: "Custom tile installation — backsplashes, showers, floors.", specialty: "Tile", skills: ["Tile Installation", "Backsplash", "Shower Tile", "Floor Tile"], location: "Dallas, TX", serviceRadius: 35, yearsExperience: 7, hourlyRate: 60, verified: true, licensed: true, insured: true, rating: 4.8, reviewCount: 52, subJobsCompleted: 98 } },
    },
  });
  ...
  await prisma.license.createMany({ data: [
    { contractorId: c1!.id, licenseNumber: "TX-GC-2019-44821", state: "TX", type: "General Contractor", expirationDate: new Date("2027-03-15"), verified: true, verifiedAt: new Date("2026-01-10") },
    { contractorId: c2!.id, licenseNumber: "TX-ME-2014-31209", state: "TX", type: "Master Electrician", expirationDate: new Date("2027-06-30"), verified: true, verifiedAt: new Date("2026-02-01") },
    { contractorId: c3!.id, licenseNumber: "TX-MP-2006-18773", state: "TX", type: "Master Plumber", expirationDate: new Date("2027-09-01"), verified: true, verifiedAt: new Date("2025-12-15") },
    { contractorId: c4!.id, licenseNumber: "TX-RF-2012-27654", state: "TX", type: "Roofing Contractor", expirationDate: new Date("2027-01-31"), verified: true, verifiedAt: new Date("2026-01-05") },
  ] });

  // Insurance
  await prisma.insuranceCert.createMany({ data: [
    { contractorId: c1!.id, provider: "State Farm", policyNumber: "SF-TX-GL-442918", coverageType: "General Liability", coverageAmount: 2000000, expirationDate: new Date("2027-01-01"), verified: true },
    { contractorId: c2!.id, provider: "Hartford", policyNumber: "HF-TX-GL-331205", coverageType: "General Liability", coverageAmount: 1000000, expirationDate: new Date("2026-12-15"), verified: true },
    { contractorId: c3!.id, provider: "Travelers", policyNumber: "TV-TX-GL-559102", coverageType: "General Liability", coverageAmount: 2000000, expirationDate: new Date("2027-03-01"), verified: true },
  ] });
  ...
  await prisma.notification.createMany({ data: [
    ...
    { userId: contractor1User.id, type: "job_posted", title: "New job matching your skills", body: "Kitchen Remodel in Austin, TX. Budget: $35K-$55K." },
    ...
    { userId: sub1User.id, type: "sub_job_posted", title: "New sub-job in your area", body: "Drywall work needed for a kitchen remodel in Austin, TX. $2,800-$4,200." },
  ] });
