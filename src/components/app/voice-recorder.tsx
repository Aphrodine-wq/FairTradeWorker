      ...
      <div className="flex flex-col items-center gap-4 py-6">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <button
            ...
            className={cn(
              "relative z-10 w-20 h-20 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-600",
              state === "idle" &&
